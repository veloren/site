...
[extra]
banner = "https://media.discordapp.net/attachments/523568428905398283/792104753881546803/unknown.png"
+++
...
- [@LunarEclipse's Veloren Journey](#lunareclipse-s-veloren-journey)
...
{{
  img(src="https://media.discordapp.net/attachments/541307708146581519/794681087132565535/unknown.png")
}}
...
{{
  img(src="https://media.discordapp.net/attachments/523568428905398283/793003650401828885/screenshot_1609137037432.png")
}}
...
Another very interesting new feature I was involved in was skill trees. These
...
receive connections represented as `PostBox`. The client would call
...
{{
  img(src="https://media.discordapp.net/attachments/467861553178345502/793988941657276446/unknown.png")
}}
...
{{
  img(src="https://media.discordapp.net/attachments/467861553178345502/785182838513205248/unknown.png")
}}
...
I used `tracy` (see the previous devblog) to analyse the bottleneck of our physics
...
rendering and UI respectively. For rendering, we are switching from `gfx` to `wgpu` and for UI we are switching from `conrod` to `iced`. One of the shared
...
`wgpu` consumes shaders compiled into SPIR-V. To get the SPIR-V shaders from our
...
screen, the chat, the skill bar, etc).
...
transitioning to at some point. `fontdue` is the [fastest text renderer](https://github.com/mooman219/fontdue#performance). Currently, we use
...
{{
  img(src="https://media.discordapp.net/attachments/541307708146581519/794639920567156764/GUUAqba.png")
}}
...
{{
  img(src="https://media.discordapp.net/attachments/523568428905398283/791499986104877076/screenshot_1608776445012.png")
}}
