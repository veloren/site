...
[extra]
banner = "/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/CaveGlow.png"
+++
...
Thanks to last three weeks' contributors @xMAC94x, @brons_glb, @juliancoffee, @naddl, @crabman and @uniior, @Isse, @laundmo,
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/ArcMoonTiger.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/Bigapple.png")}}

New treeant sapling attack
{{video(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/2024-02-17_16-06-08.mp4")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/Screenshot_2024-02-09_203750.jpg")}}

Bug report: Floating houses
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/Screenshot_20240215_011701.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1706878480641.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/weblate-veloren-workflow.jpg")}}

## Car racing event by @Vagabond and @necti

{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/poster.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/Cliffs.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/Cliffs2.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1707659983131.png")}}
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1707659773085.png")}}
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1707659688299.png")}}

{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1707929916729.png")}}

{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/CaveGlow2.png")}}
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/CaveMushroom.png")}}
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/CaveMushroom2.png")}}

{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/CaveBarren.png")}}
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/CaveBarren2.png")}}

{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/CaveLevels.png")}}

## ContentDeliveryNetwork switch

{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1708737909565.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1708742567437.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1707515304088.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/CityLights.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1708454493717.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1708738205241.png")}}
...
{{img(src="/s3.eu-central-2.wasabisys.com/veloren-blog/cdn/227/screenshot_1707272377317.png", caption="Northern shores. See you next time!")}}
