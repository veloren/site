...
{{ videopair(emoji="🔊", caption="Stalled rolls with regular sound effect", src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-03-22_horblegorble_old-rolls.webm", type="video/webm", src1="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-03-22_horblegorble_old-rolls.mp4", type1="video/mp4") }}

{{ videopair(emoji="🔊", caption="Attack-cancelling rolls with new sound effect", src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/2025-03-22_horblegorble_new-rolls.webm", type="video/webm", src1="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-03-22_horblegorble_new-rolls.mp4", type1="video/mp4") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-01-27_necti_bloodmoon-lighting.webp", caption="Voxel models and @Necti modelled voxels ") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-03-20_horblegorble_ashen-armour.webp", caption="Start practicing your smouldering gaze.") }}

Frost Gigas and Fire Gigas. Polaris and Crux. Veloren's future is full of symmetries.

{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-03-20_horblegorble_waiting-for-gigas.webp", caption="When will the Fire Gigas emerge from its molten slumber? ") }}
...
{{ videopair(emoji="🗘", caption="Before and after, before and after, yada yada", src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-03-20_horblegorble_sheeny-shiny.webm", type="video/webm", src1="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-03-20_horblegorble_sheeny-shiny.mp4", type1="video/mp4") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-03-22_horblegorble_better-dummy.webp", caption="Two very different 'face-first' mugshots") }}
...
- slight damage reduction for sword M1 and axe cleave - @unii - {{ gitlab(ids=["!4701", "!4711"]) }}
- halved duration for crippling debuff - @srpapinha - {{ gitlab(ids=["!4704"]) }}
- significantly reduced multipliers for crippling debuffs - @do-no-van - {{ gitlab(ids=["!4722"]) }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-08_Supa_carpentry-workshop.webp", caption="You did your safety induction, right?") }}

{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-08_unii_hand-cart.webp", caption="We all love a good box. But what if, they had wheels?") }}

{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-08_Supa_more-sprites.webp", caption="For all your stacking, barrelling, and bellowing needs") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-08_Supa_modular-lanterns.webp", caption="Don't lose the instruction manual") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-08_Supa_sprite-sheet.webp", caption="Time to cook up your own spread of tasty sprites!") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-11_Gemu_jungle-sprites.webp", caption="Sprite modelling for a jungle biome overhaul, compiled by @Gemu") }}

{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-11_phoenix13032005_entity-sfx.webp", caption="Various sound effects for categorised entities, compiled by @phoenix13032005") }}


#### More changes:

- rust toolchain update - @isse + @crab {{ gitlab(ids=["!4694"]) }}
- update continuous integration cache image - @crab - {{ gitlab(ids=["!4700"]) }}
- dependency updates - @NeuralModder - {{ gitlab(ids=["!4699"]) }}
- cargo package updates - @xMAC94x - {{ gitlab(ids=["!4708"]) }}
- hotfix for release build - @NeuralModder - {{ gitlab(ids=["!4710"]) }}
- parsed and localised text is converted to ascii to fix a parsing failure - @imbris - {{ gitlab(ids=["!4714"]) }}
- kelpies now swim faster in water - @souffle - {{ gitlab(ids=["!4717"]) }}
- straw hats are now sellable and stocked by merchants - @unii - {{ gitlab(ids=["!4716"]) }}
- dwarven cheese added to greedy miner loot table - @Crabo - {{ gitlab(ids=["!4719"]) }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-09_Supa_Tavern-0.webp", caption="") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-09_Supa_Tavern-1.webp", caption="") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-02_Hrom_veloren-factions.webp", caption="Thinking of a world divided — by @Hrom") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-09_Hrom_meet-the-waldos.webp", caption="Meet the Waldos") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-03_Vagabond_the-usual-suspects.webp", caption="The usual suspects, extended line up — by @Vagabond") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-03_Necti_arena-image.webp", caption="Warmup lighting — by @Necti") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-03_Sam113_tournament-migration.webp", caption="A conga line from @Sam113 turned bizarre attempt to measure the arena in 'body count'") }}


## Screenshots

{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-06_unii_shades-of-grey.webp", caption="Who knows what lurks between the shades of grey? — by @unii") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-01-25_Supa_twin-towers.webp", caption="Casual Friday attire looks very different in these neighbouring towers — by @Supa") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-01-31_And_i_tribute-to-bremen.webp", caption="A tribute to the Town Musicians of Bremen — by @And_i") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-01-25_Alley_Oop_bends-in-the-road.webp", caption="All about the journey, not the destination — by @Alley_Oop") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-07_game_r-dev_end-of-day.webp", caption="Could almost imagine your own sunset in a lantern — by @game_r/dev") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-03_Alley_Oop_floating-finish.webp", caption="To pack: 🗹 glider ☐ life jacket — by @Alley_Oop") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-01-30_necti_light-up-the-sky.webp", caption="Last moments of an unburned retina — by @Necti") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-01-31_cookiengineer_gigas-remodel.webp", caption="Frost Gigas tries their hand at some urban (re)planning — by @cookiengineer") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-02_Alley_Oop_warm-adlets.webp", caption="These Adlets are digging their heels in against climate change — by @Alley_Oop") }}
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-06_unii_biome-mixins.webp", caption="A melting pot of cave flavours — by @unii") }}
...
{{ imgzoom(src="https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/244/2025-02-11_Froggy_heatwave.webp", caption="@Froggy was tempted to ride this heatwave. Catch you on the next one :)") }}
